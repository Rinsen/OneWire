...
This should in theory give this project the possibility to run on other platforms than Windows IoT Core that feels quite dead now days and instead run on .NET Core on both Windows IoT Core and Linux on the Raspberry PI.
